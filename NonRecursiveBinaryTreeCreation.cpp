...
class Node{
    ...
    Node* left;
    public:
    Node(){  //Default constructor->they Are automayically Invoke When Object iS Created!
        data=0;
        right=NULL;
        left=NULL;
    }
...
class BT{
    ...
    void In_order(Node *temp1){ //Left Root Right
        if (temp1 != NULL)
        {
            In_order(temp1->left);
            cout << temp1->data << " ";
    ...
    void Pre_order(Node *temp1){ //root left right
        if(temp1!=NULL){
            cout<<temp1->data<<" ";
    ...
    void Post_order(Node *temp1){ //left right root
        if(temp1!=NULL){
    ...
    void count_leaves(Node *root){
        ...
        cout<<"\nNumber Of Leaves In Binary tree Are - "<<count<<endl;
    }
    ...
    void Delete_Node(Node *root){  //left right root
        if(root==NULL){
            return ;
        }else{
...
int main(){
    ...
    do
    {
        ...
        case 3:
            ...
            cout<<"\nHeight For the Binary BT Is "<<h<<endl<<endl;
            break;
        case 4:
            t1.count_leaves(root);
            int d;
